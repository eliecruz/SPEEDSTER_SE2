...
<div class="Profile-Container">
    ...
    <div class="Main-Container">
        ...
        $query = "SELECT * FROM AddressBook WHERE customer_ID = '$customer_ID' AND address_ID = '$id' ";
        $result = sqlsrv_query($conn, $query);
        $addressRow = sqlsrv_fetch_array( $result, SQLSRV_FETCH_ASSOC);
        
        ?>
        <form class="UserAddressInfo" action="backend/edit_Address.php" method="post">
            <div class="Field1">
                ...
                <input type="text" name="Location" required placeholder="House/Unit/Floor No., Building Name,, Block or Lot No." value = "<?php echo $addressRow['house_Num'] ?> ">
                
        <div class="Field2">
            <div class="Label-Input">
                <label for="city">City/Municipality, Province</label>
                <input type="text" name="City" required placeholder="City/Municipality, Province" value = "<?php echo $addressRow['city'] ?> ">
                   
                
            </div>
            <div class="Label-Input">
                <label for="Barangay">Barangay</label>
                <input type="text" name="barangay" required placeholder="Barangay" value = "<?php echo $addressRow['barangay'] ?> ">
        ...
        <div class="Field3">
            <div class="Label-Input">
                ...
                <input type="text" pattern="[0-9]{4}" name="postalCode" required placeholder="Postal Code" value = "<?php echo $addressRow['postal_Code'] ?> ">
